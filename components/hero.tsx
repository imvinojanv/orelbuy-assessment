...
const Hero = () => {
    return (
        <section className="mx-auto px-4 max-w-screen-xl">
            <div className="w-full flex max-lg:gap-2 pb-6">
                <div className="md:w-[270px] h-full hidden md:flex py-1 bg-white rounded-md flex-col items-center justify-between inset-y-0 z-50 nav-shadow">
